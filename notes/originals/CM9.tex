...
\usepackage{ntheorem}
\usepackage{tikz}
\usetikzlibrary{arrows,calc,decorations.pathmorphing,decorations.pathreplacing}
...
\paragraph*{Formal definition of computing} (Turing, 1936) : a \emph{Turing machine} (T.M.) is composed of : 
\begin{itemize}
...
\item[$\bullet$] OR by C-T thesis, simulating T is obviously algorithmic (in theintuitive sense) thus there is a Turing Machine doing it.
\end{itemize}
\end{proof}
